...
The OSF registration is an immutable, timestamped snapshot. This log, together with the public git history, establishes the order of every decision relative to the data — which is what keeps the work honest.
...
*Before registration, the plan is edited directly in `preregistration.md` (tracked in git); this log begins at the moment of OSF registration.*
